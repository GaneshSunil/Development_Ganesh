...
{
    public class NotificationBounceListener : QueueListener<AmazonSqsNotification>
    {
        public override IGNCloudMessageService<AmazonSqsNotification> GetService()
        {
            ...
            return new NotificationSesBounceMessageService(awsConfig.Id, NotificationSesBounceMessageService.QUEUE_NAME);
        }
    }
}
